...
function wpeFootNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul class="footer-nav col-md-7">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
